...
- Circle chat is an ExoTalk-style group chat attached to the Circle.
...
- Message history might still persist on devices that previously synced it; deletion is best-effort, not guaranteed erasure.
- The app should communicate this honestly to followers.

#### 2.2.3 Social intent
ThreeSteps does its best to shape follower behavior toward charity and honesty, but the protocol cannot assume perfect behavior.

## 3. Open questions (to lock next)
To implement this precisely we still need:
- Definition of destroy:
  - does it require moderator consensus, or can any member do it?
